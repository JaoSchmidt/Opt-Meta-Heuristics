...
def deepso(experiment_name,classname,coordinates,max_it=100,tcom=0.5,tmut=0.2):
  population = [classname(coord,0.5,0.5,0.5,np.zeros(len(coord)),coord) for coord in coordinates]
  generation_data=[]
  gen_number=0
